 ...
 */
final class Version20230523073955 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart ADD user_id INT NOT NULL, ADD product_id INT NOT NULL, DROP id_user, DROP id_product');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart ADD id_user INT NOT NULL, ADD id_product INT NOT NULL, DROP user_id, DROP product_id');
    }
}
